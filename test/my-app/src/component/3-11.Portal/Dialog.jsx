...
export default function Dialog(props) {
    ...
    return (
        <>
            ...
            {typeof props.button === 'string' ? (<button onClick={() => setIsOpen(false)} style={{backgroundColor: "red", color: "white"}}>{props.button}</button>) : <div onClick={() => setIsOpen(false)}>{props.button}</div> }
